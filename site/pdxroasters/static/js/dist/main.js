...
exports.roasters = undefined;
exports.sortDistanceList = sortDistanceList;
...
(0, _$2.default)('.js-list-toggle').on('click', function (e) {
  e.preventDefault();
  (0, _$2.default)('.js-list-toggle').removeClass('active');
  (0, _$2.default)('.js-list-content').addClass('hidden');
  (0, _$2.default)(e.target).addClass('active');
  (0, _$2.default)('.js-' + e.target.dataset.sort + '-list').removeClass('hidden');
});

function distance(roaster, location) {
  var latlng = new _leaflet2.default.LatLng(parseFloat(roaster.dataset.lat), parseFloat(roaster.dataset.lng));
  var distance = latlng.distanceTo(location.latlng) * 0.000621371;
  return parseFloat(distance.toFixed(2));
}

function sortDistanceList(location) {
  var list = (0, _$2.default)('.js-by-distance-item').filter(function (roaster) {
    return roaster.dataset.lat && roaster.dataset.lng;
    ...
    (0, _$2.default)(roaster).removeClass('greyed-out');
    return roaster;
  }).sort(function (a, b) {
...
exports.locationFound = exports.addRoasters = undefined;
...
var roasterMarker = _leaflet2.default.icon({
...
var deviceMarker = _leaflet2.default.icon({
...
_leaflet2.default.tileLayer('http://{s}.tiles.mapbox.com/v3/financialtimes.map-w7l4lfi8/{z}/{x}/{y}.png', {
  maxZoom: 18,
...
function addRoaster(r) {
  if (r.lat && r.lng) {
    ...
    _leaflet2.default.marker([r.lat, r.lng], { icon: roasterMarker }).addTo(map).bindPopup(popup);
  } else {
...
map.on('locationfound', function (e) {
  ...
  if (e.latitude > 45.2 && e.latitude < 45.9 && e.longitude > -123.1 && e.longitude < -122.4) {
    _leaflet2.default.circle(e.latlng, 120, deviceCircle).addTo(map);
    _leaflet2.default.marker(e.latlng, { icon: deviceMarker }).addTo(map);
    map.panTo(e.latlng);
  }
});

var addRoasters = exports.addRoasters = function addRoasters(arr) {
  return arr.forEach(addRoaster);
};
var locationFound = exports.locationFound = function locationFound(cb) {
  return map.on('locationfound', cb);
};

},{"leaflet":7}],4:[function(require,module,exports){
'use strict';
...
var _doSomethingOnScroll = require('do-something-on-scroll');

var _doSomethingOnScroll2 = _interopRequireDefault(_doSomethingOnScroll);
...
var anchor = (0, _$2.default)('.js-nav-anchor'); /**
                                                  * Make the correct link active in top nav and scroll to correct section
                                                  */

var listAnchor = (0, _$2.default)('.js-list-anchor');
var mapAnchor = (0, _$2.default)('.js-map-anchor');

anchor.on('click', function (e) {
  e.preventDefault();
  (0, _smoothscroll2.default)(document.getElementById(e.target.dataset.scrollTo));
});

function update() {
  var win = document.documentElement.scrollTop || document.body.scrollTop;
  var listOffset = document.querySelector('.js-list').offsetTop;
...
},{"../lib/$":1,"do-something-on-scroll":6,"smoothscroll":9}],5:[function(require,module,exports){
'use strict';
...
},{"./lib/list":2,"./lib/map":3,"./lib/scroll":4}],6:[function(require,module,exports){
