...
_map2.default.init();
_map2.default.setupList();
_map2.default.getRoasters();
_map2.default.locate();
_map2.default.toggleList();

_scroll2.default.init();
_scroll2.default.updateActive();
_scroll2.default.smoothScroll();

_forms2.default.validate();

},{"./forms":1,"./map":3,"./scroll":4}],3:[function(require,module,exports){
'use strict';
...
var Map = {
  ...
  addMarker: function addMarker(lat, lng, popup) {
    _leaflet2.default.marker([lat, lng], { icon: roasterMarker }).addTo(map).bindPopup(popup);
  },
  addPopUp: function addPopUp(name, slug) {
    var popup = '<h5><a href="roaster/' + slug + '">' + name + '<span class="right-arrow"></span></a></h5>';
    return popup;
  },
  roasters: null,
  getRoasters: function getRoasters() {
  ...
  locationFound: function locationFound(e) {
    ...
    if (e.latitude > 45.2 && e.latitude < 45.9 && e.longitude > -123.1 && e.longitude < -122.4) {
      ...
      _leaflet2.default.circle(e.latlng, 120, device).addTo(map);
    ...
    if (Map.roasters && Map.location) {
      ...
      for (var i = 0; i < Map.roasters.length; i++) {
        ...
        if (roaster.lat && roaster.lng) {
          var latlng = new _leaflet2.default.LatLng(roaster.lat, roaster.lng);
...
define(["jquery"], function ($) {
  ...
  var Scroll = {
    ...
    updateUrl: function updateUrl(obj, title, url) {
      history.replaceState(obj, title, url);
    },
    activate: function activate(active, inactive, status, url) {
